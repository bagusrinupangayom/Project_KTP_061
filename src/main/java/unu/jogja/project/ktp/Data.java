...
public class Data implements Serializable {
    ...
    public String getBerakhirhingga() {
        return berakhirhingga;
    }

    public void setBerakhirhingga(String berakhirhingga) {
        this.berakhirhingga = berakhirhingga;
    }
